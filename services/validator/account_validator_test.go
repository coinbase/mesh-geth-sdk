...
func TestValidateAccountState_Success(t *testing.T) {
	...
	data, err := os.ReadFile("testdata/account_proof_block.json")
	if err != nil {
	...
	if err != nil {
		t.Fatalf("failed to decode first node: %v", err)
	}
	...
	t.Run("AccountFieldValidation", func(t *testing.T) {
		...
		t.Run("OriginalBalance", func(t *testing.T) {
			...
			err := v.ValidateAccountState(ctx, validResult, correctStateRoot, big.NewInt(5219647))
	...
	t.Run("ProofStructureValidation", func(t *testing.T) {
		...
		t.Run("StateRootCalculation", func(t *testing.T) {
			...
			err = v.ValidateAccountState(ctx, validResult, calculatedStateRoot, big.NewInt(5219647))
	...
	t.Run("ContextVariations", func(t *testing.T) {
		...
		t.Run("BackgroundContext", func(t *testing.T) {
			...
			err := v.ValidateAccountState(bgCtx, baseAccountResult, correctStateRoot, big.NewInt(5219647))
		...
		t.Run("ContextWithValues", func(t *testing.T) {
			...
			err := v.ValidateAccountState(ctxWithValue, baseAccountResult, correctStateRoot, big.NewInt(5219647))
		...
		t.Run("CancelledContext", func(t *testing.T) {
			...
			err := v.ValidateAccountState(cancelCtx, baseAccountResult, correctStateRoot, big.NewInt(5219647))
